...
public class PhrasesActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        getSupportFragmentManager().beginTransaction()
                .replace(R.id.container, new PhrasesFragment()) //this installs the NumbersFragment into the NumberActivity. Change the NumbersFragment to something else and you will see the change of fragment!
                .commit();
    }
